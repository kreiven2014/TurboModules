...
Class<RCTComponentViewProtocol> RCTThirdPartyFabricComponentsProvider(const char *name) {
  static std::unordered_map<std::string, Class (*)(void)> sFabricComponentsClassMap = {
    ...
    {"RNGestureHandlerButton", RNGestureHandlerButtonCls}, // rngesturehandler,
    {"RNGestureHandlerRootView", RNGestureHandlerRootViewCls}, // rngesturehandler

    {"RNCSafeAreaProvider", RNCSafeAreaProviderCls}, // SafeAreaContextSpec,
    {"RNCSafeAreaView", RNCSafeAreaViewCls}, // SafeAreaContextSpec
